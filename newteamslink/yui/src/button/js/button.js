...
Y.namespace('M.atto_newteamslink').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    ...
    _togglenewteamslink: function() {
        ...
        // Use the "newteamslink" command for simplicity. This will toggle <strong> tags off as well.
        document.execCommand('newteamslink', false, null);

        // Then change all <b> tags to <strong> tags. This will change any existing <b> tags as well.
        host.changeToCSS('b', 'bf-editor-newteamslink-strong');
        host.changeToTags('bf-editor-newteamslink-strong', 'strong');
    }
});
